...
def parse_option():
    ...
    parser.add_argument('--learning_rate', type=float, default=0.00005, help='learning rate', required=False)
    parser.add_argument('--epochs', type=int, default=10, help='number of training epochs', required=False)
    parser.add_argument('--window_size', type=int, default=32, help='window size', required=False)
    parser.add_argument('--head_size', type=int, default=16, help='Single head size of the MultiHeadAttention', required=False)
    parser.add_argument('--n_embed', type=int, default=64, help='Embedding size of the model', required=False)
    parser.add_argument('--n_layer',type=int, default=4, help='Number of Decoder Blocks', required=False)
